...
describe('GetDetailThreadUseCase', () => {
  it('should orchestrating GetDetailThread Correctly', async () => {
    ...
    mockThreadRepository.getThreadById = jest.fn().mockImplementation(() => Promise.resolve(getThreadById));
    mockCommentRepository.getCommentByThreadId = jest.fn().mockImplementation(() => Promise.resolve(listComment));
    mockReplyRepository.getReplyByThreadId = jest.fn().mockImplementation(() => Promise.resolve(listReply));
